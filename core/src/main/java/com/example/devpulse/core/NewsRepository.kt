...
interface NewsRepository {
    ...
    fun getAllRssSources(): Flow<List<RssSource>>
    suspend fun insertRssSource(source: RssSource)
    suspend fun deleteRssSource(source: RssSource)

    fun isDefaultsInitialized(): Boolean
    fun setDefaultsInitialized(initialized: Boolean)
}
